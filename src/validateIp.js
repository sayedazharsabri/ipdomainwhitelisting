"use strict";
function isFullIPAddress(ipPattern) {
...
function isAllowedFormat(ipPattern) {
    const ipAllowedPatternRegex = /^(?:\d{1,3}\.){0,3}(?:\d{1,3}|\*)(?:\.\d{1,3}|\.\*|\*)?$/;
    return ipAllowedPatternRegex.test(ipPattern);
}
const checkWhiteList = (whitelistPatternsListToCheck) => {
